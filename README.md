...
<html lang="en">
  ...
  <body>    
        <div class="jumbotron jumbotron-fluid" style="background-color:paleturquoise;">        
...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:palevioletred; ">
...
Thus, a webserver is designed to display house price prediction and is hosted in the URL
 http://prashethaa.student.saveetha.in:8000/HouseModelTraining/

& 
http://prashethaa.student.saveetha.in:8000/HouseModelPrediction/